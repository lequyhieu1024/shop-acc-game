    ...
    return (
        <div className="container mx-auto px-4 py-12 relative">
            <div className="flex justify-between items-center mb-6">
                ...
                <Link href={link} className="text-blue-600 hover:text-blue-800 flex items-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {items.map((item) => (
                                ...
                                {badgeText && (
                                    <div className="absolute right-2 z-10">
                                        <Badge.Ribbon
                                            ...
                                            text={<span className="animate-bounce inline-block">{badgeText}</span>}
                                            color="magenta"
                                        />
                                    </div>
                                )}
                    ...
                    >
                        <div>
                            {item.name && <h3 className="text-sm font-medium line-clamp-2">{item.name}</h3>}
                            {showPrice && (
            ...
            <Modal
                ...
                styles={{ mask: { backgroundColor: "rgba(0, 0, 0, 0.45)" }, body: { padding: "24px", textAlign: "center" } }}
            >
