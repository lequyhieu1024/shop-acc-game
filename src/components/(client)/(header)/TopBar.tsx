...
import { FaShoppingCart, FaCaretDown, FaEyeSlash, FaEye } from "react-icons/fa";
          ...
          {session?.user && (
            <div className="hidden sm:flex items-center space-x-2 p-4 ">
              ...
              <div className="text-sm text-white font-mono">
                {showBalance ? `${session?.user?.balance.toLocaleString()} đ` : "******"}
              </div>
              <button
                  ...
                  <>
                    <li className="sm:hidden px-5 py-3 hover:bg-gray-100 transition-colors rounded-md">
                      <div className="flex items-center space-x-2  ">
                        <div className="text-[12px]  font-semibold">Số dư:</div>
