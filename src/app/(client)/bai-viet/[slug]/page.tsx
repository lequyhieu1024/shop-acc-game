            ...
            <main className="container mx-auto px-4">
                <nav aria-label="Breadcrumb" className="mb-6">
                    <ol className="flex items-center">
                        ...
                        <li className="mr-2">
                            <Link href="/bai-viet" className="text-purple-300 hover:text-purple-200 transition-colors">
                                Bài viết
                            </Link>
                        </li>
                        <li className="mx-2 text-gray-300">/</li>
                ...
                <article className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-purple-500/20 shadow-xl">
                    <header className="mb-8">
                        <h1 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-purple-300 to-blue-300 bg-clip-text text-transparent">
                            {post.title}
                        </h1>
                    ...
                    <footer className="mt-12 pt-6 border-t border-purple-500/20">
