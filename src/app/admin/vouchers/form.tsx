                                    ...
                                    <div className="row">
                                        <div className="mb-4 row align-items-center">
                                            ...
                                            <div className="col-md-9 col-lg-10">
                                                <input className="form-control" type="text" value={data.name}
                                        ...
                                        <div className="mb-4 row align-items-center">
                                            <label
                                                ...
                                                giảm</label>
                                            <div className="col-md-9 col-lg-10">
                                                <input className="form-control" type="number" value={data.value}
                                                       onChange={handleInputChange} name="value" placeholder="vnđ"/>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-md-9">
                                                <div className="form-check user-checkbox ps-0">
                                                    <input className="checkbox_animated check-it"
                                                           type="checkbox" checked={data.type === "private"}
                                                           onChange={handleCheckboxChange} name="type"
                                                           id="flexCheckDefault"/>
                                        ...
                                        <div className="mb-4 row align-items-center">
                                            ...
                                            <div className="col-md-9 col-lg-10">
                                                <input className="form-control" value={data.quantity}
                                                       onChange={handleInputChange} name="quantity" type="number"/>
                                            </div>
                                        </div>
