...
export default function BannerForm({initialData = null, isEditing = false}: BannerEditProps) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.status === 200) {
                sessionStorage.setItem("message", `Banner đã được ${isEditing ? "cập nhật" : "tạo"} thành công!`);
                                ...
                                <div className="card-body">
                                    ...
                                    <form onSubmit={handleSubmit} className="theme-form theme-form-2 mega-form">
                                        <div className="mb-4 row align-items-center">
                                            <label className="form-label-title col-sm-3 mb-0">Trạng thái</label>
                                            <div className="col-sm-9">
                                                <select
                                                    className="form-control" onChange={handleChange}
                                                    name="is_active">
                                                    <option selected={formData.is_active === "1"} value="1">Hoạt động</option>
                                                    <option selected={formData.is_active === "0"} value="0">Không hoạt động</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-4 row align-items-center">
                                            ...
                                            <div className="col-sm-9">
                                                ...
                                                {fileReading && (
                                                    <div className="mt-2">
                                                        <img src={fileReading} alt="Banner"
                                        ...
                                        <div className="mb-4 d-flex gap-2 col-sm-12 col-md-6 justify-content-center">
                                            ...
                                            <Link href="/admin/banners" className="btn btn-warning flex-grow-1">
                                                Trở lại
                                            </Link>
                                        </div>
                                    </form>
