                    ...
                    <div className="card-body p-0">
                        <div className="category-slider no-arrow">
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/vegetable.svg" className="img-fluid" alt=""/>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/cup.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Beverages</h6>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/meats.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Meats & Seafood</h6>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/breakfast.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Breakfast</h6>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/frozen.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Frozen Foods</h6>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/milk.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Milk & Dairies</h6>
                                    </a>
                            ...
                            <div>
                                <div className="dashboard-category">
                                    <a href="#" className="category-image">
                                        <img src="/admin/assets/svg/pet.svg" className="img-fluid" alt=""/>
                                    </a>
                                    <a href="#" className="category-name">
                                        <h6>Pet Food</h6>
                                    </a>
