...
export default function ProductForm({
    ...
    const validateForm = () => {
        ...
        if (!formData.code.trim()) newErrors.code = "Mã tài khoản không được để trống";
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mb-4 row align-items-center">
                                        ...
                                        <div className={isEditing ? "d-none" : "col-md-2"}>
                                            <button className="btn btn-primary" onClick={autoGenerateCode}>
                                                Tự động tạo
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="mb-4 row align-items-center">
                                        ...
                                        <div className="col-md-9">
                                            <input
                                                className={`form-control ${errors.number_diamond_available ? "is-invalid" : ""}`}
                                                type="number"
                                    ...
                                    <div className="mb-4 row align-items-center">
                                        <label className="form-label-title col-md-3 mb-0">Server</label>
                                        <div className="col-md-9">
                                            <input
                                                className="form-control"
                                                type="text"
